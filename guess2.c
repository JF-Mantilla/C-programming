 ...
 * number generator using the time of day.             *
 *******************************************************/
void initialize_number_generator(void)
{
 ...
 * the user whether each guess is too low, too high, or  *
 * correct. When the guess is correct, prints the total  *
